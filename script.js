document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    // Typing placeholder while waiting
    const thinkingBubble = appendMessage("Navigator", "", false, true);
    ...
    log.removeChild(thinkingBubble);
  ...
  function appendMessage(sender, text, isInstant = false, isThinking = false) {
    ...
    if (isThinking) {
      textSpan.className = "italic animate-pulse text-gray-500";
      textSpan.textContent = "Product Coach is thinking...";
    } else if (isInstant) {
