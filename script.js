document.addEventListener("DOMContentLoaded", () => {
  ...
  function parseMarkdown(text) {
    return text
      ...
      .replace(/^# (.*$)/gim, "<h3 class='text-lg font-bold mb-2'>$1</h3>")  // Heading
      .replace(/^- (.*$)/gim, "<li class='list-disc ml-5'>$1</li>")          // List
      .replace(/\n/g, "<br>")                                                // Line breaks
  ...
  downloadButton.addEventListener("click", async () => {
    ...
    function setPageHeader(doc) {
      ...
      doc.text("Generated by the Product Coach at JoshAdams.io/product-coach", pageWidth / 2, 60, { align: "center" });
